...
class ManageUserDetails extends StatefulWidget {
  const ManageUserDetails({Key? key}) : super(key: key);

  @override
  _ManageUserDetailsState createState() => _ManageUserDetailsState();
}

class _ManageUserDetailsState extends State<ManageUserDetails> {
  @override
