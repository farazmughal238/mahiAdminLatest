...
import 'Manage_module_tab.dart';
import 'TabBarss/newDetails.dart';

class AppTab extends StatefulWidget {
  bool fromEdit;
  AppTab({Key? key, required this.fromEdit}) : super(key: key);
...
class _AppTabState extends State<AppTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ManageTab(fromEdit: widget.fromEdit),
      bottomNavigationBar: Container(
        height: Responsive.isMobile(context) ? 80 : 75,
        ...
        child: Padding(
          padding: EdgeInsets.only(left: Responsive.isMobile(context)?10 :30, right: Responsive.isMobile(context)?5 :30),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              RichText(
                text: TextSpan(
                  ...
                  style:
                      GoogleFonts.openSans(fontSize: Responsive.isMobile(context)?14 :18, color: Colors.black),
                  children: <TextSpan>[
                    TextSpan(
                        text: 'will be added to your next billing cycle',
                        style:
                            TextStyle(fontSize: Responsive.isMobile(context)?8 :9, color: Color(0xff6a6a6a))),
                  ],
                ),
              ),
              Row(
