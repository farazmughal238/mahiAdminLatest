...
class _NewDetailState extends State<NewDetail> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Padding(
              padding: EdgeInsets.only(left: Responsive.isMobile(context)? 10:50,top: 20),
              child: Row(
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Container(
                        width:
                        Responsive.isMobile(context) ? media.width * 0.85 : null,
                        child: Responsive.isMobile(context) ? Text(
                          "Allow staff, visitors and contractor to sign in and out"
                              "Includes a log , signature and photo. Can ping admin and "
                              "visitors persons",
  ...
  Container buildContainer(Size media) {
    return Container(
      ...
      width: Responsive.isMobile(context)?media.width * 0.90 :media.width * 0.45,
